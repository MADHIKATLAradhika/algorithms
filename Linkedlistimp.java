...
public static void main(String[] args){
        ...
        llist.insertingnode("Radhika");
        llist.insertingnode("Praneetha");
        llist.insertingnode("Sai Lakshmi");
        llist.insertingnode("Lokeshwari");
        // llist.display();
        // llist.addAtStarting("Dhoni");
        llist.addAtMiddle("Preethi",2);
        llist.display();
    }
}